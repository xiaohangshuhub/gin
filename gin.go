...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	for _, group := range engine.RouterMap {

		engine.AddRoute(group.Method, group.Path, group.Handlers, group.AuthSchemes, group.AuthzPolicies, group.LimitersPolices, group.AllowAnonymous)
